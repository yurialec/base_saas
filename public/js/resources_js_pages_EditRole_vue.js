...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    loadData: function loadData() {
      var _this2 = this;
      this.isLoading = true;
      Promise.all([axios.get("/roles/find/".concat(this.id)), axios.get('/roles/dropdown-list'), axios.get('/roles/list-permissions')]).then(function (_ref) {
        var _ref2 = _slicedToArray(_ref, 3),
          roleResponse = _ref2[0],
          rolesResponse = _ref2[1],
          permissionsResponse = _ref2[2];
        var role = Array.isArray(roleResponse.data) ? roleResponse.data[0] : roleResponse.data;
        _this2.role = _this2.normalizeRole(role);
        _this2.roles = Array.isArray(rolesResponse.data) ? rolesResponse.data : [];
        _this2.permissions = Array.isArray(permissionsResponse.data) ? permissionsResponse.data : [];
    ...
    update: function update() {
      var _this3 = this;
      this.isLoading = true;
      axios.put("/roles/update/".concat(this.id), this.createRequestPayload()).then(function () {
    ...
    normalizeRole: function normalizeRole(role) {
      ...
      return {
        ...
        permissions: Array.isArray(normalizedRole.permissions) ? normalizedRole.permissions : []
      };
    },
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("section", _hoisted_1, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_2, [_cache[7] || (_cache[7] = (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("h1", {
  ...
  }, null, 8 /* PROPS */, ["loading"]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_3, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_4, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_5, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_6, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_7, [_cache[8] || (_cache[8] = (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("label", {
    "for": "roleName",
    "class": "form-label"
    ...
    trim: true
  }]])]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_9, [_cache[11] || (_cache[11] = (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("label", {
    "for": "roleParent",
    "class": "form-label"
    ...
    type: "checkbox",
    role: "switch"
  }, null, 512 /* NEED_PATCH */), [[vue__WEBPACK_IMPORTED_MODULE_0__.vModelCheckbox, $data.role.is_active]]), _cache[12] || (_cache[12] = (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("label", {
    "class": "form-check-label",
    "for": "roleIsActive"
  }, "Perfil ativo", -1 /* CACHED */))])]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_13, [_cache[14] || (_cache[14] = (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("label", {
    "for": "rolePermissions",
    "class": "form-label"
    ...
    noResult: (0,vue__WEBPACK_IMPORTED_MODULE_0__.withCtx)(function () {
      return _toConsumableArray(_cache[13] || (_cache[13] = [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createTextVNode)(" Nenhuma permissão encontrada. ", -1 /* CACHED */)]));
    }),
    _: 1 /* STABLE */
  }, 8 /* PROPS */, ["modelValue", "options", "disabled"])])]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_14, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(_component_router_link, {
    "class": "btn btn-outline-secondary btn-sm",
    to: "/roles"
  }, {
    "default": (0,vue__WEBPACK_IMPORTED_MODULE_0__.withCtx)(function () {
      return _toConsumableArray(_cache[15] || (_cache[15] = [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createTextVNode)(" Cancelar ", -1 /* CACHED */)]));
    }),
    _: 1 /* STABLE */
  ...
  }, null, -1 /* CACHED */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createTextVNode)(" Salvar ", -1 /* CACHED */)])), 8 /* PROPS */, _hoisted_15)])])])])], 32 /* NEED_HYDRATION */)]);
}
